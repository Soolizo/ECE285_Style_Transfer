...
def build_parser():
    ...
    parser.add_argument('--style', default='/Users/liukunpeng/Documents/fast-style-transfer/examples/starry-night-van-gogh.jpg',type=str,
                        dest='style', help='style image path',
                        metavar='STYLE')
    parser.add_argument('--train-path', default='/Users/liukunpeng/Documents/fast-style-transfer/train_images/',type=str,
                        dest='train_path', help='path to training images folder',
                        metavar='TRAIN_PATH')

    parser.add_argument('--save-path', default='/Users/liukunpeng/Documents/fast-style-transfer/net/',type=str,
                        dest='save_path',
